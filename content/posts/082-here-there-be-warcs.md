...
| 16. Replaced the OBJ Datastream Using FEDORA | Success | I navigating to _Digital.Grinnell_'s FEDORA admin page at http://dgdocker1.grinnell.edu:8081/fedora/admin/, opened object grinnell:27858, and used the FEDORA admin interface there to replace the OBJ datastream. I allowed the upload portion of the process to "spin" for more than an hour, but when I stopped it and saved changes I found a new OBJ that is 1.97 GB in size. The new OBJ appears to be viable. |
